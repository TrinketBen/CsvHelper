...
namespace CsvHelper
{
	...
	public struct ReadingExceptionOccurredArgs
	{
		...
		public ReadingExceptionOccurredArgs(CsvHelperException exception)
		{
			...
			// !BENNOTE! Not sure if this is correct; error was:
			// Auto-implemented property 'ReadingExceptionOccurredArgs.Record' must be fully assigned before control is
			// returned to the caller. Consider updating to language version 'preview' to auto-default the property.
			Record = default;
		}
	}
}
